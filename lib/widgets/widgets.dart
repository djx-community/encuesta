...
Future<void> generalSnackBar(BuildContext context, String message) async{
  final snackBar = SnackBar(behavior: SnackBarBehavior.floating,content: Text(message),action:SnackBarAction(label: "Undo",onPressed: (){},),duration:const Duration(seconds: 2),);
